...
(defrecord BucketDate [bucket-nb]
  ...
  (add-delay [_ delay-date]
    (core-type-arg/assert-protocols "BucketDate/add"
                                    [[optimization-date/DelayDate delay-date]]
                                    (->BucketDate (+ bucket-nb
                                                     (optimization-date/delay-date delay-date)))))
  (substract-delay [_ delay-date]
    (core-type-arg/assert-protocols "BucketDate/substract-delay"
                                    [[optimization-date/DelayDate delay-date]]
                                    (->BucketDate (- bucket-nb
                                                     (optimization-date/delay-date delay-date))))))
...
(defn make-bucket-date
  ...
  * `bucket-nb` bucket number - Integer"
  [bucket-nb]
  (core-type-arg/assert-positive-integer bucket-nb
